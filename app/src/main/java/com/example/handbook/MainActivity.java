...
private Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        array = getResources().getStringArray(R.array.animal_array);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        toolbar.setTitle(R.string.menu_animal);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        (id == R.id.nav_food)
        {
            ...
            array = getResources().getStringArray(R.array.food_array);
            adapter.clear();
            adapter.addAll(array);
            adapter.notifyDataSetChanged();
            category_index = 1;
        ...
        {
            toolbar.setTitle(R.string.menu_diseases);
            array = getResources().getStringArray(R.array.diseases_array);
            adapter.clear();
            adapter.addAll(array);
            adapter.notifyDataSetChanged();
            category_index = 2;
        ...
        {
            toolbar.setTitle(R.string.menu_care);
